...
export default function Approvals() {
  ...
  return (
    <div className="animate-fade-in">
      ...
      {visible.length === 0 ? (
        <EmptyState icon={ClipboardCheck} title="Nothing to review" description="There are no items matching this filter." />
      ) : (
            ...
            >
              <div className="min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-medium text-slate-400">{a.refNumber}</span>
                  <StatusBadge status={a.priority} />
                </div>
                <p className="mt-1.5 truncate font-semibold text-slate-900">{a.title}</p>
              ...
              <div className="flex items-center justify-between gap-4 sm:justify-end">
                <span className="text-base font-bold text-slate-900">{formatCurrency(a.amount)}</span>
